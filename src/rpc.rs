...
impl Connection {
    ...
    fn server_version(&self, params: &[serde_json::Value]) -> Result<Value> {
        if params.len() != 2 {
        ...
        Ok(serde_cbor::value::to_value(format!("electrs {}, {}", ELECTRS_VERSION, PROTOCOL_VERSION)).unwrap())
    ...
    // fn server_banner(&self) -> Result<serde_json::Value> {
    //     Ok(json!(self.query.get_banner()?))
    // }
    //
    // fn server_donation_address(&self) -> Result<serde_json::Value> {
    //     Ok(serde_json::Value::Null)
    // }
    //
    // fn server_peers_subscribe(&self) -> Result<serde_json::Value> {
    //     Ok(json!([]))
    // }
    //
    // fn mempool_get_fee_histogram(&self) -> Result<serde_json::Value> {
    //     Ok(json!(self.query.get_fee_histogram()))
    // }
    //
    // fn blockchain_block_header(&self, params: &[serde_json::Value]) -> Result<serde_json::Value> {
    ...
    // }
    //
    // fn blockchain_estimatefee(&self, params: &[serde_json::Value]) -> Result<serde_json::Value> {
    ...
    // }
    //
    // fn blockchain_relayfee(&self) -> Result<serde_json::Value> {
    ...
    fn handle_command(&mut self, method: &str, params: &[serde_json::Value], id: &serde_json::Value) -> Result<serde_json::Value> {
        let timer = self
            .stats
            .latency
